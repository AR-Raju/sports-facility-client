...
import { createFacility } from "@/store/slices/facilitiesSlice";
...
function AddFacilityContent() {
  ...
  const onSubmit = async (data: FacilityFormValues) => {
    ...
    try {
      ...
      const result = await dispatch(createFacility(facilityData));
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          ...
          <p className="text-gray-600">
            Create a new sports facility for booking
          </p>
        </div>
      </div>
              ...
              <Button type="submit" disabled={isSubmitting || isUploading}>
                {isSubmitting || isUploading ? (
                  <>
                    ...
                    {isUploading ? "Uploading to ImageBB..." : "Creating..."}
                  </>
                ) : (
                  "Create Facility"
                )}
